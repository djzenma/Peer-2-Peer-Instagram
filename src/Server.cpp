...
Message buildImageMsg(int image_id ,string hidden, std::string request_id){
    // char* wd;
    // getwd(wd);
    std::string path ="/Users/ayashaker/Desktop/Distributed_Project2/images/mine/" + to_string(image_id)+ ".jpg";
    std::string temp_path = "/Users/ayashaker/Desktop/Distributed_Project2/images/stego" + to_string(image_id)+ "_stego.jpg";
...
void Server::updateCount(int image_id, int num_views){
    std::string image_path ="/Users/ayashaker/Desktop/Distributed_Project2/images/requested" + to_string(image_id) + ".jpg";
    std::string output = stega_decode(image_path);
    int sep_index = output.find(',');
    std::string tempPath ="/Users/ayashaker/Desktop/Distributed_Project2/images/stego/temp.jpg";
...
int Server::serveRequest(){
    ...
    Thread * thrd = new Thread(false , true ,  reqNum ,image_id,false, 4040 , "" , "", 0 ); //server thread
