...
Message Communication::buildImageMsg(int image_id, std::string owner_ip, std::string owner_name) {
    // TODO
    std::string path =
            "/Users/ayashaker/Desktop/Distributed_Project2/images/mine/" + std::to_string(image_id) + ".jpg";
    std::string temp_path =
            "/Users/ayashaker/Desktop/Distributed_Project2/images/stego/" + std::to_string(image_id) + "_stego.jpg";
